...
public class ModCircleRecipes {
    ...
    public static final CircleRecipe GOLD = register("gold", new CircleRecipe(new ItemStack(Items.GOLD_INGOT, 2),
            List.of(new ItemStack(Items.IRON_INGOT, 4), new ItemStack(Items.GOLD_NUGGET, 2)), false, List.of(0), 10, 80));
    public static final CircleRecipe NETHERITE_INGOT = register("netherite_ingot", new CircleRecipe(new ItemStack(Items.NETHERITE_INGOT, 1),
