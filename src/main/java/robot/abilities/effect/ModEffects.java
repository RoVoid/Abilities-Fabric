...
public class ModEffects {
    public static final StatusEffect PHOENIX = registerEffect("phoenix", new PhoenixEffect());
    public static final StatusEffect DORMANT_PHOENIX = registerEffect("dormant_phoenix", new DormantPhoenixEffect());
