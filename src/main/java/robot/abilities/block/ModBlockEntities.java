...
public class ModBlockEntities {
    ...
    public static final BlockEntityType<LecternBlockEntity> LECTERN_BLOCK_ENTITY = Registry.register(Registries.BLOCK_ENTITY_TYPE, new Identifier(AbilitiesMod.ID, "lectern"), FabricBlockEntityTypeBuilder.create(LecternBlockEntity::new, ModBlocks.LECTERN).build());
}
